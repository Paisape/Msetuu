...
const Logo = ({ color, isStatic = false }: { color?: CSSProperties['color']; isStatic?: boolean }) => {
  // Refs
  ...
  return (
    <div className='flex items-center'>
      <img src='/images/logo-mandirsetuu.png' alt='Logo' className='h-8 w-auto object-contain' />
      <LogoText
        color={color}
        ref={logoTextRef}
