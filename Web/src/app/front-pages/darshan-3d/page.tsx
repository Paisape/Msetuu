...
// Formerly the "Darshan" page — moved here and relabeled "3D Darshan" so /front-pages/darshan
// could be freed up for the newer, separate day-wise interactive Darshan experience. Nothing in
// this feature's data (DarshanTemple model, /api/darshan routes) changed, only the route/labels.
const Darshan3DPage = () => {
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        {loading ? (
          ...
          <Typography className='text-center text-slate-400 py-16'>
            No 3D Darshan temples have been added yet — check back soon.
          </Typography>
        ) : (
